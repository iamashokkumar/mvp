								...
								if (nominees.length > 0) {
									for (var i = 0; i < nominees.length; i++) {
										...
										if (nominees[i].MVPNomineeAvatarFileData == "" || nominees[i].MVPNomineeAvatarFileData == null || nominees[i].MVPNomineeAvatarFileData ==
											...
											nominees[i].MVPNomineeAvatarFileData =
												"https://assets0-jam4.sapjam.com/images/personShadow330x330.png?412166170dd5ef6b7f4c6dfdf2c5ac57230"
										}
									...
									if (!!(window.File) && !!(window.FileReader) && !!(window.FileList) && !!(window.Blob)) {
										...
										if (files != undefined) {
											...
											if (fileName.toUpperCase() == 'JPG' || fileName.toUpperCase() == 'PNG' || fileName.toUpperCase() == 'JPEG') {
												...
												MessageToast.show("Allowed file types: JPG, PNG, JPEG.");
											}
